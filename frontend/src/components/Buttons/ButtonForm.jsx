...
const ButtonForm = ({ 
    ...
    // Update local state if initialButton changes (useful for Edit mode after data loads)
    useEffect(() => {
    ...
    return (
        <div className="flex flex-col w-full p-4 md:p-6">
            ...
            <h1 className="text-2xl font-bold mb-6 md:mb-8 text-left md:text-left">{title}</h1>
